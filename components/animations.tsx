...
export function TypingAnimationDemo({ className }: { className?: string }) {
  return (
    <div className={cn("max-w-[600px]", className)}>
      <TypingAnimation
        className="text-xs sm:text-sm text-center sm:text-left text-[#483D8B] font-[family-name:var(--font-geist-mono)]"
...
export function NumberTickerDemo({
  ...
  return (
    <div>
      ...
      <p
        className={`whitespace-pre-wrap text-2xl sm:text-5xl font-bold text-[#FFD700] font-inter tracking-tighter ${
          className || ""
        }`}
      >
